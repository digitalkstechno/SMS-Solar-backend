...
const { getKwGrowth, getSalesWinRate, getLeadsBySource, getRevenueGrowth } = require("../controller/analytics");
...
router.get("/revenue-growth", authMiddleware, leadReadScope(), getRevenueGrowth);
